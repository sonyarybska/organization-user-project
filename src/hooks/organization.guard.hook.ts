...
export const organizationGuardHook: preHandlerAsyncHookHandler = async function (request) {
  ...
  try {
    ...
    const userOrganization = userOrganizations.find((uo) => uo.organizationId === organizationId);
