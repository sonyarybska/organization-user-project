...
export class AddCompanyTable1770215481710 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."CsvImportRecord_status_enum"`);
    await queryRunner.query(`ALTER TABLE "CsvImportRecord" ADD "status" character varying NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "Company" ADD CONSTRAINT "FK_c67133d954d8fba046931e66110" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "CsvImportRecord" ADD CONSTRAINT "FK_58d2641261f0e5950733d816900" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "CsvImportRecord" ADD "status" "public"."CsvImportRecord_status_enum" NOT NULL DEFAULT 'new'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "CsvImportRecord" ADD CONSTRAINT "FK_58d2641261f0e5950733d816900" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
  }
}
